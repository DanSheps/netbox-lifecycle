...
def create_test_supportcontract(
    contract_id=None, vendor=None, start=None, renewal=None, end=None
):
    if vendor is None:
    ...
    return SupportContract.objects.create(
        vendor=vendor, contract_id=contract_id, start=start, renewal=renewal, end=end
    )
