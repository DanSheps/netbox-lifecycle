...
urlpatterns = [
    ...
    path(
        'sku/<int:pk>/edit', views.SupportSKUEditView.as_view(), name='supportsku_edit'
    ),
    path(
        'sku/<int:pk>/delete',
