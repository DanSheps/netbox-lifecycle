...
class SupportContractForm(NetBoxModelForm):
    ...
    class Meta:
        ...
        fields = ('vendor', 'contract_id', 'start', 'renewal', 'end', 'tags')
        widgets = {
            'start': DatePicker(),
            'renewal': DatePicker(),
            'end': DatePicker(),
...
class SupportContractAssignmentForm(NetBoxModelForm):
    ...
    class Meta:
        ...
        fields = ('contract', 'sku', 'device', 'license', 'end', 'tags')
        widgets = {
            'end': DatePicker(),
        }
...
class LicenseAssignmentForm(NetBoxModelForm):
    ...
    class Meta:
        ...
        fields = ('vendor', 'license', 'device', 'quantity', 'tags')
